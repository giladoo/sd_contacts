        ...
        data.forEach(rec => {
            ...
            <div class="col-12 row mx-0 mb-1 px-0 border-bottom align-items-center shadow-sm">
                <div class="col-3 col-md-2 py-1">
                    <div class="img_div rounded-circle border p-1 border-gray" style="background-image: url(/web/image?model=hr.employee&amp.public&amp;id=${rec.id}&amp;field=avatar_128)"></div>
                </div>
